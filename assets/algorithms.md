...
- [Алгоритмы](#alrogithms)

## Структуры данных <a name="structures"></a>
...
### Связный список (linked list) <a name="list"></a>
...
- [Бинарный](#binary)
- [Двоичное дерево поиска](#binary_tree)

#### Бинарный (двоичный) (binary) <a name="binary"></a>
...
#### Бинарное (двоичное) дерево поиска (binary search tree) <a name="binary_tree"></a>
