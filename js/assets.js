...
`,
    rightAnswer: `C`,
    explanation: `
Из-за очереди событий в JavaScript колбек функции "setTimeout" выполняется после освобождения стека вызовов. Так как переменная "i" в первом цикле определяется с помощью ключевого слова "var", она является глобальной. В цикле мы каждый раз увеличиваем значение i на 1, используя оператор "++". К моменту выполнения колбека setTimeout в первом примере значение i равняется 3. Во втором цикле переменная "i" определяется с помощью ключевого слова "let". Такие переменные (а также переменные, объявленные с помощью ключевого слова "const") имеют блочную область видимости (блок - это код внутри фигурных скобок ({})). На каждой итерации i будет иметь новое значение, и это значение будет замкнуто в области видимости внутри цикла.
`,
  },
...
`,
    rightAnswer: `C`,
    explanation: `
new Number() - это встроенная функция-конструктор. И хотя она выглядит как число, это не настоящее число: у него имеется ряд дополнительных возможностей. На самом деле, это объект. Оператор "==" (абстрактное равенство) разрешает преобразование типов данных, он проверяет равенство значений. Оба значения равны 3, поэтому возвращается true. При использовании оператора "===" (строговое равенство) должны совпадать не только значения и типы данных. В данном случае это не так: new Number() это не число, а объект. Поэтому два последних сравнения возвращают false.
`,
  },
...
`,
    answers: `
A: Person {firstName: "John", lastName: "Smith"}  undefined
B: Person {firstName: "John", lastName: "Smith"}  Person {firstName: "Jane", lastName: "Air"}
C: Person {firstName: "John", lastName: "Smith"}  {}
D: Person {firstName: "Smith", lastName: "Smith"}  error
`,
    rightAnswer: `A`,
    explanation: `
Мы создаем объект "jane" без ключевого слова "new". Использование new приводит к созданию нового объекта (экземпляра). Без new создается глобальный объект. Мы указали, что this.firstName равняется "Jane" и this.lastName - "Air". На самом деле, мы определили global.firstName = 'Jane' и global.lastName = 'Air'. Значением jane является undefined, поскольку мы не возвращаем значение из Person.
`,
  },
...
`,
    rightAnswer: `C`,
    explanation: `
Оператор распространения или раширения (spread, ...) возвращает массив с аргументами, переданными функции. Массив - это объект, поэтому выражение "typeof args" возвращает object.
`,
  },
...
`,
    rightAnswer: `B`,
    explanation: `
С помощью ключевого слова "var" можно определять любое количество одноименных переменных. Переменная будет хранить последнее присвоенное ей значение. Однако, такой трюк нельзя проделать с let и const, т.к. они имеют блочную область видимости.
`,
  },
...
`,
    answers: `
A: undefined is 30 John is 30
B: function function
C: John is 30 John is 30
D: John is 30 function
`,
    rightAnswer: `D`,
    explanation: `
...
`,
    rightAnswer: `A`,
    explanation: `
Строка является итерируемой (переьираемой) сущностью. Оператор распространения или расширения (spread, ...) преобразует строку в массив, состоящий из символов этой строки.
`,
  },
...
`,
    rightAnswer: `B`,
    explanation: `
Когда мы передаем несколько промисов методу "race", он возвращает первый разрешенный (выполненный или отклоненный) промис. В метод "setTimeout" мы передаем задержку в 500 мс для первого промиса и 100 мс для второго. Это означает, что secondPromise разрешается первым со значением "two". Переменная "res" имеет значение "two", которое и выводиться в консоль.
`,
  },
...
`,
    rightAnswer: `B`,
    explanation: `
С помощью цикла "for..in" мы перебираем ключи объекта, в данном случае "name" и "age". Ключи объекта (кроме Symbol) являются строками. В каждом цикле мы устанавливаем значение "item" равным текущему ключу, по которому он перебирается. Сначала item равен name, и выводится в консоль. Затем item равен age.
`,
  },
...
`,
    rightAnswer: `C`,
    explanation: `
Функция "parseInt" проверяет, являются ли символы в строке допустимыми с точки зрения используемой системы счисления (второй аргумент). Как только встречается недопустимый символ, синтаксический анализ строки прекращается и последующие символы игнорируются. "*" является недопустимым числом. Поэтому parseInt прекращает разбор строки и возвращает 7.
`,
  },
...
`,
    rightAnswer: `D`,
    explanation: `
С помощью оператора "throw" мы можем создавать собственные ошибки. Другими словами, с помощью этого оператора мы можем генерировать пользовательские исключения. Исключением может быть строка, число, логическое значение или объект. В данном случае, исключением является строка "Hello World!". С помощью оператора "catch" мы можем указать, что делать, если в блоке "try" возникла ошибка. Исключение - "Hello World!". "er" равняется этой строке. Это приводит к "Ошибка: Hello World!".
`,
  },
...
`,
    rightAnswer: `A`,
    explanation: `
Выражение "let x = y = 10" на самом деле является сокращением для:
...
`,
    rightAnswer: `C`,
    explanation: `
Импортируемый модуль доступен только для чтения: мы не можем его изменять. Это можно сделать только перед экпортом. Когда мы пытаемся увеличить значение переменной "myCounter", возникает ошибка: myCounter доступен только для чтения и не может быть изменен.
`,
  },
...
`,
    answers: `
A: { name: "John", age: 30 }  ["name", "age"]
B: { name: "John", age: 30 }  ["name"]
C: { name: "John"}  ["name", "age"]
D: { name: "John"}  ["age"]
`,
    rightAnswer: `B`,
    explanation: `
...
`,
    rightAnswer: `A`,
    explanation: `
Второй аргумент JSON.stringify() - это заменитель (replacer). Заменитель может быть либо функцией, либо массивом, и позволяет контролировать, что и как должно быть преобразовано в значения. Если заменитель является массивом, только свойства, указанные в нем, будут добавлены в JSON-строку. В данном случае, в строку включаются только свойства "level" и "health", "username" исключается. Значением переменной "data" равняется {"level": 19, "health": 90}. Если заменитель является функцией, она вызывается для каждого свойства объекта. Значение функции будет значением свойства при добавлении в строку. Если значением свойства является "undefined", такое свойство исключается из состава строки.
`,
  },
...
`,
    answers: `
A: "John Smith"  "John Smith"
B: " John Smith"  " John Smith" ("[12x whitespace]John Smith"  "[2x whitespace]John Smith")
C: " John Smith"  "John Smith" ("[1x whitespace]John Smith", "John Smith")
D: "John Smith"  "Jo"
`,
    rightAnswer: `C`,
    explanation: `
...
A: "📱💻"
B: 257548
C: Строка, содержащая кодовые обозначения эмодзи
D: error
`,
    rightAnswer: `A`,
    explanation: `
...
`,
    rightAnswer: `C`,
    explanation: `
Асинхронная функция всегда возвращает промис. await ожидает разрешения промиса: промис возвращается, когда мы вызываем getData(), чтобы установить переменную "data" равным ему. Если бы мы хотели получить доступ к разрешенному значению "Я сделал это!", мы могли бы использовать метод "then" для data: data.then(res => console.log(res)). Тогда бы в консоль было выведено "Я сделал это!"
`,
  },
...
{0: "☕", 1: "💻", 2: "🍷", 3: "🍫"} <br>
где ключи - перечисляемые свойства. "0 1 2 3" выводится в консоль. С помощью цикла "for..of" мы выполняем итерацию итераций. Массив является итерируемой (перебираемой) сущностью. Когда мы выполняем итерацию по массиву, переменная "item" равняется итерируемому элементу, "☕" "💻" "🍷" "🍫" выводится в консоль.
`,
  },
...
`,
    rightAnswer: `C`,
    explanation: `
Элементами массива могут быть любые типы данных. Числа, строки, объекты, другие массивы, null, логические значения, undefined и даже даты, функции и выражения. Элемент будет равен возвращаемому значению. Выражение "1 + 2" возвращает 3, "1 * 2" - 2, а "1 / 2" - 0.5.
`,
  },
...
`,
    rightAnswer: `D`,
    explanation: `
"...args" - это прочие параметры (оператор "rest"). Значение rest - это массив, содержащий неиспользованные аргументы и в этой связи передаваемый последним. В приведенном примере rest является вторым аргументом. Это приводит к синтаксической ошибке.
<pre><code class="lang-js">
...
`,
    answers: `
A: a больше, 6  b больше, 3
B: a больше, undefined  b больше, undefined
C: undefined  undefined
D: error
`,
    rightAnswer: `B`,
    explanation: `
В JavaScript мы не должны явно указывать точку с запятой (;), однако, интерпретатор автоматически добавляет их после операторов. Оператором могут быть переменные или ключевые слова, такие как throw, return, break и т.д. В приведенном примере имеется инструкция "return" и выражение "a + b" на новой строке. Поскольку это новая строка, движок не знает, что это значение, которое мы хотим вернуть. Он автоматически добавляет точку с запятой после return. Это выглядит так:
<pre><code class="lang-js">
return;
a + b
</code></pre>
...
`,
    answers: `
A: [1, [2, 3, 4]]  undefined
B: [1, [2, 3, 4]]  { name: "John", age: 30 }
C: [1, 2, 3, 4]  { name: "John", age: 30 }
D: null  { name: "John", age: 30 }
`,
    rightAnswer: `A`,
    explanation: `
...
`,
    answers: `
A: I have resolved!, first  I have resolved!, second
B: first, I have resolved!  second, I have resolved!
C: I have resolved!, second  first, I have resolved!
...
В функции "generatorTwo" мы используем ключевое слово "yield*". Это означает, что первое значение равняется первому значению итератора. Итератор - это массив "['a', 'b', 'c']". Первым значением данного массива является "a", поэтому когда мы вызываем two.next().value, возвращается "a".
<pre><code class="lang-js">
...
`,
    rightAnswer: `C`,
    explanation: `
Условие в цикле "forEach" проверяет, является ли значение num истинным. Поскольку первым значением num является 0, который является ложным, код в блоке "if" не выполняется. Остальные значения num (1, 2, 3) являются истинными, поэтому значение count увеличивается на 1 три раза. В результате значением count становится 3.
`,
  },
...
`,
    rightAnswer: `A`,
    explanation: `
Функция "updateEmail" является стрелочной, поэтому она не привязана к объекту "user". Это означает, что ключевое слово "this" не ссылается на объект "user", в данном случае, оно указывает на глобальную область видимости (window в браузере, global в Node.js). Значение свойства "email" объекта "user" не обновляется. Поэтому, когда мы обращаемся к user.email, в консоль выводится my@email.com.
`,
  },
...
3. Далее "setTimeot" отправляется в WebAPI, а оставшийся код выполняется дальше. <br>
4. В стек помещается console.log('C'), выполняется и удаляется из стека. <br>
5. Колбек setTimeout помещается в очередь задач (task queue, второе слово читается как "кью"). <br>
6. Функция "main" удаляется из стека. <br>
7. После того, как стек вызовов опустел, в него помещается колбек из очереди задач. <br>
...
`,
    rightAnswer: `B`,
    explanation: `
Оператор "+" применяется как к числам, так и к строкам. Если одним из операндов является строка, тогда тогда второй операнд также приводится к строке, и операнды объединяются. Это называется конкатенацией. Оператор "-" пытается преобразовать операнды в число. При невозможности это сделать возращается NaN.
`,
  },
...
`,
    rightAnswer: `A`,
    explanation: `
Set - это объект, представляющий собой коллекцию уникальных значений, поэтому повторяющиеся значения исключаются. В тоже время данный объект является чуствительным к регистру, поэтому в коллекцию записываются и "F", и "f".
`,
  },
...
`,
    rightAnswer: `D`,
    explanation: `
await возвращает Promise {: 10}, который может быть обработан с помощью then(). В данном случае, функция не содержит оператора "return", т.е. не возвращает значение. Поэтому возвращается undefined. Приведенный пример эквивалентен следующему:
<pre>
<code class="lang-js">
function func () {
...
`,
    answers: `
A: 1 2 3 5 Process completed!
B: 5 5 5 5 Process completed!
C: Process completed! 5 5 5 5
D: Process completed! 1 2 3 5
`,
    rightAnswer: `D`,
    explanation: `
...
`,
    rightAnswer: `D`,
    explanation: `
Сравнение "a" и "b" возвращает false, поскольку эти переменные ссылаются на разные места в памяти, несмотря на то, что их значения являются одинаковыми. В JavaScript в случае с объектами значения передаются по ссылке. Во втором случае "d" является копией "c", поэтому они ссылаются на одну область памяти. Любые изменения в "c" отражаются на "d". Третий пример демонстирует способ копирования массива с помощью метода "slice". "f" является копией "e", но они ссылаются на разные места в памяти. Поэтому их сравнение возвращает false.
`,
  },
...
`,
    answers: `
A: You score 1989 times  You score 1963 times
B: You score 1959 times  You score 1989 times
C: You score 1989 times  You score 1953 times
D: You score 1959 times  You score 1963 times
`,
    rightAnswer: `D`,
    explanation: `
bind() позволяет привязать функцию к объекту. В данном случае, мы привязываем функцию "score" к объектам "ronaldo" и "messi". Функция "score" принимает три параметра: year, tr и t, где "tr" и "t" должны быть функциями. Когда мы привязываем score() к ronaldo и messi, мы передаем ей три аргумента, два из которых, "transfrom" и "title", являются функциями.
`,
  },
...
`,
    rightAnswer: `D`,
    explanation: `
В данной задаче приводится пример использования this в разных контекстах, когда мы объявляем анонимную функцию внутри метода объекта. Первые три метода являются распространенными способами обработки this: с помощью this как второго параметра map(), bind(this) в forEach (или map()) или с помощью приема "that = this" (мы используем self вместо that). Метод "Me" приводит к неожиданному результату, поскольку "this.name" не привязано к объекту "club". Обратите внимание, что при тестировании кода в jsbin мы получаем другой результат. В Chrome и Firefox мы получаем 0.
`,
  },
...
`,
    rightAnswer: `C`,
    explanation: `
"..." используется двумя способами: как оператор распространения (spread) и как прочие параметры (rest). В приведенном примере мы видим оба способа. Первый оператор в самовызывающейся функции - это, разумеется, rest, а в константе "c" мы видим spread. В первом случае мы можем передать фукнции любое количество аргументов. Обратите внимание, что "typeof a" - это "object", несмотря на то, что фактически - это настоящий массив (в отличие от массивоподобного объекта "arguments"). spread позволяет нам объединять массивы. Таким образом, "...a" - это оператор rest при использовании в качестве параметра функции, но в константе - это оператор spread. Мы получаем "c" с пятью элементами ("...a" - это вложенный массив, поэтому его длина равняется 1), но первый элемент имеет 10 элементов (когда мы передали в функцию new Array(10)). Сумма длин обоих массивов равняется 15.
`,
  },
...
`,
    rightAnswer: `D`,
    explanation: `
"..." в массиве - это spread-оператор (оператор распространения), который похож на rest-оператор (прочие параметры). Данный оператор позволяет объединять (изменять) и копировать массивы. В примере "b" - это копия "a". Тем не менее, когда мы передаем "a" в Set, возвращаются только уникальные значения. Это означает, что "b" содержит [1, 2, "one", 3, "two"].<br>
Затем мы устанавливаем значение длины "b" равным 3 ("one".length).<br>
Таким образом, мы уменьшили длину массива. Вот почему в консоль выводится только [1, 2, "one"].
`,
  },
...
`,
    rightAnswer: `B`,
    explanation: `
Прежде всего, следует заметить, что мы не можем использовать arguments в стрелочных функциях. arguments - это массивоподобный объект, который содержит аргументы, переданные при вызове функции.<br>
...
Обратите внимание, что в функции "two" мы возвращаем "arguments[arguments[0]]" или 2, а не 1, поскольку arguments[0] возвращает 1, а arguments[1] - 2.<br>
...
В итоге мы получаем "8 + 7" или 15.
`,
  },
...
`,
    rightAnswer: `D`,
    explanation: `
Array.prototype.some() - это встроенная функция, позволяющая обрабатывать элементы массива с помощью колбека. Колбек в примере имеет три параметра: currentValue (значение текущего элемента массива), index (индекс текущего элемента) и ages (сам массив).<br>
...
Результирующим выражением является "return (node + deno + done).length", где node - "I love you", deno - "love" и done - "I done you". Результирующая длина равняется 24 (I love you love I done you). Пробелы принимаются в расчет.
`,
  },
...
Для перебора массива обычно используется цикл "for..of" или классический цикл "for". Использование for..in для этого является плохой практикой. for..in, как правило, используется для перебора объектов.
`,
  },
