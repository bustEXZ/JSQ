                                    ...
                                    for (var u = 0; u < s.length; ++u) {
                                        ...
                                        for (var m = c.pattern || c, y = a.next, k = i; y !== t.tail && !(l && k >= l.reach); k += y.value.length, y = y.next) {
                                            ...
                                            if (!(b instanceof W)) {
                                                ...
                                                if (h && y != t.tail.prev) {
                                                    var w;
                                                    if (m.lastIndex = k, !(w = m.exec(n))) break;
                                                    var A = w.index + (f && w[1] ? w[1].length : 0),
                                                        P = w.index + w[0].length,
                                                        S = k;
                                                    for (S += y.value.length; S <= A;) S += (y = y.next).value.length;
                                                    if (k = S -= y.value.length, y.value instanceof W) continue;
                                                ...
                                                if (w) {
                                                    ...
                                                    var C = y.prev,
                                                        _;
                                                    L && (C = I(t, C, L), k += L.length), z(t, C, x), y = I(t, C, new W(o, g ? M.tokenize(O, g) : O, v, O)), N && I(t, y, N), 1 < x && e(n, t, r, y.prev, k, {
                                                        cause: o + "," + u,
                                                        reach: j
                                                    })
                                                }
